...
#用来得到不同的栏目数据
    def get_all_(self,url,keyStr,total_page):
        pages_arary = []
...
if __name__ == '__main__':
    ...
    count = 1
    classinfo = []
    url = 'http://www.dy2018.com/html/dongman/index.html'#'http://www.hltm.tv/list/7.html'#'http://www.hltm.tv/list/18.html'
    mySpider = spider()
